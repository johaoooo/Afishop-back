...
const createTrainingSchema = z.object({
  ...
  // Prix stocké en texte en BDD (ex. "100 000 FCFA") : on accepte nombre ou texte
  price: z.union([z.string().min(1, 'Le prix est requis'), z.number().positive('Le prix doit être positif')]),
...
const updateTrainingSchema = z.object({
  ...
  price: z.union([z.string().min(1), z.number().positive()]).optional(),
  modules: z.array(moduleSchema).optional(),
  students: z.coerce.number().int().min(0).optional(),
  image: z.string().url().or(z.string()).optional(),
  color: z.string().optional(),
